            ...
            <header className="d-flex align-items-center">
                <div className="container-fluid w-100">
                    <div className="row d-flex align-items-center w-100">
                        {/* Logo Wraooer */}
                        <div className="col-sm-2 part1 pr-0" style={styles.container}>
                        <Link to={'/'} className="d-flex align-items-center logo" style={styles.link}>
                            <img src={logo} alt="Rani Enterprises Logo" style={styles.logoImage} />
                            <span className="ml-2 logo-text" style={styles.logoText}>RANI ENTERPRISES</span>
                        </Link>
                        </div>
...
const styles = {
    ...
    // Media queries with JavaScript for responsive styling
