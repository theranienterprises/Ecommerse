...
router.get(`/temp/:id`, async (req, res) => {
  const parentId = req.params.id; // Get the id from the request parameters
  console.log(parentId);
  try {
    const categoryList1 = await Category.find({ parentId: parentId }); // Filter categories by parentId
