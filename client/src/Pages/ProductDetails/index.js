...
import { FaShare, FaWhatsapp, FaFacebook } from "react-icons/fa";
...
const ProductDetails = () => {
    ...
    const buyNow = () => {
        if (activeSize !== null) {
            ...
            context.addToBuyNow(buyNowFields);
        } else {
            setTabError(true);
        }
    };
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-7 pl-5 pr-5 part2">
                            ...
                            <div className="d-flex align-items-center mt-3 actions_">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <Button className="btn-blue btn-lg btn-big btn-round bg-red" onClick={buyNow}>
                                    <BsCartFill /> &nbsp;
                                    Buy Now
                                </Button>
                            ...
                            <Tooltip title={`${isAddedToMyList === true ? 'Added to Wishlist' : 'Add to Wishlist'}`} placement="top">
                                    <Button className={`btn-blue btn-lg btn-big btn-circle`} onClick={() => addToMyList(id)}>
                                        {
                                ...
                                <Button className="btn-blue btn-lg btn-big btn-circle ml-2" onClick={() => setSharePopupOpen(true)}>
                                    <FaShare />
                                </Button>
                                </Tooltip>
  ...
  fullWidth
  maxWidth="sm" // This will increase the width of the dialog
>
  <DialogTitle>
    Share This Product
    <IconButton
  ...
  <DialogContent>
    ...
    />
    <Button onClick={copyToClipboard} className="btn-blue btn-lg btn-big btn-round mb-3">
      Copy URL
    </Button>
    <div className="justify-content-around">
      <Tooltip title="Share on WhatsApp" placement="bottom">
        ...
        >
          <FaWhatsapp size={30} style={{backgroundColor:'green'}}/>
        </IconButton>
      </Tooltip>
      <Tooltip title="Share on Facebook" placement="bottom">
        ...
        >
          <FaFacebook size={30} style={{backgroundColor:'blue'}} />
        </IconButton>
      </Tooltip>
    </div>
  </DialogContent>
